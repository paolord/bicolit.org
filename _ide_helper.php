...
class Feed extends Roumen\Feed\Facades\Feed{
	/**
	 ...
	 * @static 
	 */
	 public static function add($title, $author, $link, $pubdate, $description){
		 Roumen\Feed\Feed::add($title, $author, $link, $pubdate, $description);
	 }
	 ...
	 * @static 
	 */
	 public static function render($format = 'atom'){
		return Roumen\Feed\Feed::render($format);
	 }
